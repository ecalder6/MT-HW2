...
def main(options):
  ...
  batched_test_src, batched_test_src_mask, _ = utils.tensor.advanced_batchize(src_test, 48, src_vocab.stoi["<pad>"])
  batched_test_trg, batched_test_trg_mask, _ = utils.tensor.advanced_batchize(trg_test, 48, trg_vocab.stoi["<pad>"])
